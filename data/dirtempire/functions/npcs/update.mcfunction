...
execute as @e[type=snow_golem] if score @s temp matches 750.. at @s run loot spawn ~ ~ ~ loot dirtempire:christmas/snow_golem_idle
execute as @e[type=snow_golem] if score @s temp matches 751.. run scoreboard players set @s temp 0