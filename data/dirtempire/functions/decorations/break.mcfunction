...
execute as @e[type=item_frame,tag=decoration] at @s if block ~ ~-1 ~ air if block ~ ~-1 ~ void_air if block ~ ~-1 ~ cave_air run summon item ~ ~ ~ {Item:{Count:1,id:"minecraft:item_frame"},Motion:[0.0,0.25,0.0]}
execute as @e[type=item_frame,tag=decoration,name=christmas_wreath] at @s if block ~ ~-1 ~ air if block ~ ~-1 ~ void_air if block ~ ~-1 ~ cave_air run function dirtempire:items/convert_to/advent_wreath
execute as @e[type=item_frame,tag=decoration,name=christmas_tree] at @s if block ~ ~-1 ~ air if block ~ ~-1 ~ void_air if block ~ ~-1 ~ cave_air run function dirtempire:items/convert_to/christmas_tree
